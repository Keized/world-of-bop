...
contract Bop is ERC721, Ownable {
    ...
    constructor() ERC721("BOP", "BOP") public {
        _owner = msg.sender;
    }
    ...
    function _validate(uint256 _id) internal {
        require(_exists(_id), "Error, wrong Bop id");
        require(!sold[_id], "Error, Bop is Sold");
        require(msg.value >= price[_id], "Error, Bop costs more");
    }
